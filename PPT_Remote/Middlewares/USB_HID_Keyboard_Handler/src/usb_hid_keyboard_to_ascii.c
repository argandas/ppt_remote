...
static const keyboard_HID2ASCII_t usb_hid_keyboard_to_ascii_table [] = {
		...
		{'\b', USB_HID_MOD_NONE,          USB_HID_KEY_BACKSPACE},
		{'-', USB_HID_MOD_NONE,           USB_HID_KEY_HYPHEN},
		{'_', USB_HID_MOD_RIGHT_SHIFT,    USB_HID_KEY_HYPHEN},
		{'=', USB_HID_MOD_NONE,           USB_HID_KEY_EQUAL},
		{'+', USB_HID_MOD_RIGHT_SHIFT,    USB_HID_KEY_EQUAL},
		{'[', USB_HID_MOD_NONE,           USB_HID_KEY_BRACKET_OPEN},
		{'{', USB_HID_MOD_RIGHT_SHIFT,    USB_HID_KEY_BRACKET_OPEN},
		{']', USB_HID_MOD_NONE,           USB_HID_KEY_BRACKET_CLOSE},
		{'}', USB_HID_MOD_RIGHT_SHIFT,    USB_HID_KEY_BRACKET_CLOSE},
		{'\\', USB_HID_MOD_NONE,          USB_HID_KEY_BACKSLASH},
		{'|', USB_HID_MOD_RIGHT_SHIFT,    USB_HID_KEY_BACKSLASH},
		{';', USB_HID_MOD_NONE,           USB_HID_KEY_SEMICOLON},
		{':', USB_HID_MOD_RIGHT_SHIFT,    USB_HID_KEY_SEMICOLON},
		{',', USB_HID_MOD_NONE,           USB_HID_KEY_COMMA},
		{'>', USB_HID_MOD_RIGHT_SHIFT,    USB_HID_KEY_COMMA},
		{'.', USB_HID_MOD_NONE,           USB_HID_KEY_PERIOD},
		{'<', USB_HID_MOD_RIGHT_SHIFT,    USB_HID_KEY_PERIOD},
		{'"', USB_HID_MOD_RIGHT_SHIFT,    0x34},
		{'/', USB_HID_MOD_NONE,           USB_HID_KEY_SLASH},
		{'?', USB_HID_MOD_RIGHT_SHIFT,    USB_HID_KEY_SLASH},
};
